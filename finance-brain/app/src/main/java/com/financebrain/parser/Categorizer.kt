...
object Categorizer {
    ...
    private val rules: List<Pair<Regex, String>> = listOf(
        ...
        Regex("""\bsip\b|zerodha|groww|upstox|kuvera|coin|mutual fund|\bmf\b|nps|ppf|etmoney|paytm money|angel one|icici direct|hdfc sec|kotak sec|smallcase|indmoney|rd instal|fd\b|fixed deposit""") to Categories.INVESTMENT,
